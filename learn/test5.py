...
class LoginTest(unittest.TestCase):
    ...
    def test_strategic(self):
        ...
        selector = Select(driver.find_element_by_xpath('//*[@id="createTypeCheck"]'))
        ...
        driver.find_element_by_xpath('//*[@id="addPolicyInfoDialog"]/div[1]/div/div/form/div/fieldset/div/input[3]').send_keys('123456')
